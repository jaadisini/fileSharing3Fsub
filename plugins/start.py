...
# Regular /start command for welcoming new users or returning users (whether subscribed or not)
...
# Force join if user tries to access a file link without subscribing to the channel first
