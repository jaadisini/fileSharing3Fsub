...
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", 
    "Hello {first},\n\n"
    "🛎 You need to join the channels to use me ((ሰላም፣ ፋይሉን ለማግኘት  ቻናሎቹን Join ማረግ አለብዎት)
)\n\n"
    "📭 Please join the channels first and click 'Try Again' (ቻናሎቹን Join ከረጉ በኋላ ከታች 'Try again' የሚለውን ተጫኑ)"
)
